...
namespace dsp::demo
{
void demo(dsp::MoveStream& stream)
{
    ...
    stream << dsp::OnboardConfig("changecolor black 0 0 0")
           << dsp::OnboardConfig("changecolor white 255 255 255");
    std::this_thread::sleep_for(700ms);
    stream << dsp::OnboardConfig("changecolor black 189, 153, 117")
           << dsp::OnboardConfig("changecolor white 255, 243, 204");
    std::this_thread::sleep_for(700ms);
